...
# Form implementation generated from reading ui file 'resources/ui/widgets/customwidget.ui'
#
...
class Ui_productWidget(object):
    def setupUi(self, productWidget):
        ...
        self.gridLayoutWidget.setGeometry(QtCore.QRect(360, 0, 97, 112))
        self.gridLayoutWidget.setObjectName("gridLayoutWidget")
        self.gridLayout = QtWidgets.QGridLayout(self.gridLayoutWidget)
        self.gridLayout.setContentsMargins(0, 0, 0, 0)
        self.gridLayout.setObjectName("gridLayout")
        self.addButton = QtWidgets.QWidget(self.gridLayoutWidget)
        self.addButton.setMinimumSize(QtCore.QSize(95, 31))
        self.addButton.setMaximumSize(QtCore.QSize(95, 31))
        self.addButton.setStyleSheet("    background-color: rgba(99, 169, 159, 1);\n"
"    border-style: solid;\n"
...
"")
        ...
        self.label_4 = QtWidgets.QLabel(self.addButton)
        self.label_4.setGeometry(QtCore.QRect(0, 0, 95, 31))
...
"}")
        ...
        self.removeButton = QtWidgets.QWidget(self.gridLayoutWidget)
        self.removeButton.setMinimumSize(QtCore.QSize(95, 31))
        self.removeButton.setMaximumSize(QtCore.QSize(95, 31))
...
"")
        ...
        self.label_5 = QtWidgets.QLabel(self.removeButton)
        self.label_5.setGeometry(QtCore.QRect(0, 0, 95, 31))
